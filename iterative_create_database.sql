...
ALTER TABLE  introns AUTO_INCREMENT = ?;
ALTER TABLE  exons AUTO_INCREMENT = ?;
ALTER TABLE  real_exons AUTO_INCREMENT = ?;
ALTER TABLE  isoforms AUTO_INCREMENT = ?;
ALTER TABLE  genes AUTO_INCREMENT = ?;
ALTER TABLE  sequences AUTO_INCREMENT = ?;
ALTER TABLE  organisms AUTO_INCREMENT = ?;
ALTER TABLE  chromosomes AUTO_INCREMENT = ?;
ALTER TABLE  intron_types AUTO_INCREMENT = 1;
ALTER TABLE  tax_groups2 AUTO_INCREMENT = ?;
ALTER TABLE  tax_groups1 AUTO_INCREMENT = ?;
ALTER TABLE  tax_kingdoms AUTO_INCREMENT = ?;
ALTER TABLE  orthologous_groups AUTO_INCREMENT = 1;
ALTER TABLE orphaned_cdses AUTO_INCREMENT = ?;
