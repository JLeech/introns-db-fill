...
void Worker::run()
{
    ...
    _semaphore.acquire();
    QString decompress_command = "gzip -d " + _args.dataFolder;
    system (decompress_command.data());
    ...
    QString compress_command = "gzip " + _args.dataFolder;
    system (compress_command.data());
